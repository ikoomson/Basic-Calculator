...
public class Calculator extends JFrame
{
	...
	public static void main(String args[])
	{
		 ...
		 JButton numOne = new JButton("1"); JButton numTwo = new JButton("2"); JButton numThree = new JButton("3");
		 JButton numFour = new JButton("4"); JButton numFive = new JButton("5"); JButton numSix = new JButton("6");
		 JButton numSeven = new JButton("7"); JButton numEight = new JButton("8"); JButton numNine= new JButton("9");
		 JButton numZero = new JButton("0");

		 JButton clearResult = new JButton("Clear"); JButton addNum= new JButton("+");  JButton minusNum= new JButton("-");
		 JButton multiplyNum= new JButton("*");  JButton divideNum= new JButton("/"); JButton equals= new JButton("=");
		 JButton decimal = new JButton("."); JButton plusMinus = new JButton("\u00B1");
		 ...
		 calcButtonPanel.add(numZero);calcButtonPanel.add(addNum);calcButtonPanel.add(minusNum); 
		 calcButtonPanel.add(multiplyNum);calcButtonPanel.add(divideNum);calcButtonPanel.add(equals);
		 calcButtonPanel.add(plusMinus); calcButtonPanel.add(decimal); calcButtonPanel.add(clearResult);
